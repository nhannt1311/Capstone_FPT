...
function BaocaoStadiumWait() {
  ...
  async function getDoneReport() {
    var requestOptions = {
      method: 'PUT',
      redirect: 'follow'
    };

    fetch("http://192.168.1.10:8084/api/ReportStadiums/updateStatus/"+localStorage.getItem('idAcc1')+"/"+localStorage.getItem('idSta')+"/"+localStorage.getItem('idRep'), requestOptions)
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header">
                    <h4 className="card-title"> Vi Phạm Đang Xử Lý</h4>
                  </div>
                  <div className="card-body">
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        {data ? data.filter(data => data.statusReport === "Wait").map(record => (
...
export default BaocaoStadiumWait