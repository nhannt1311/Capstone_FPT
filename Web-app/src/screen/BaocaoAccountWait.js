...
function BaocaoAccountWait() {
  ...
  async function getDoneReport() {
    ...
    fetch("http://192.168.1.10:8084/api/accountReports/updateStatus/"+localStorage.getItem('idAcc1')+"/"+localStorage.getItem('idAcc2')+"/"+localStorage.getItem('idAccRep'), requestOptions)
...
export default BaocaoAccountWait