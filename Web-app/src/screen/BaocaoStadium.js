...
function BaocaoStadium() {
  ...
  async function getError() {
    let path = `/BaocaoStadiumError`;
    history.push(path);
  }

  async function getWait() {
    let path = `/BaocaoStadiumWait`;
    history.push(path);
  }
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header">
                    <h4 className="card-title">Quản Lý Vi Phạm Sân</h4>
                  </div>
                        ...
                        <tbody className="dulieu">
                          ...
                          .filter((val) => {
                            if (search == ""){
                              ...
                              return val
                            }else if (val.stadium.account.nameAcc.toLowerCase().includes(search.toLowerCase())){
                              return val
                            }
                          }).map(record => (
                            <tr>
