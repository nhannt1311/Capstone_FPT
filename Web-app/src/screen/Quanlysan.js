                          ...
                          {data ? data
                            .filter((val) => {
                              ...
                              <tr>
                                ...
                                <td className="text-truncate" style={{ maxWidth: '150px' }} >{record.priceMin.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}đ ~ {record.priceMax.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}đ</td>
                                ...
                                {record.account.lock === 0 ?
                                  <td className="text-truncate" style={{ maxWidth: '150px', color: 'green' }} >Sân đang hoạt động</td>
                                  : <td className="text-truncate" style={{ maxWidth: '150px', color: '#C60021' }} >Sân Đã Bị Khóa</td>
                                }
                              </tr>
                            )) : (<div></div>)}
                        </tbody>
